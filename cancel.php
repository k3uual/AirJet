...
<html>
    ...
    <div class="container">
        <?php
            ...
            include("connect.php");
            $query="select * from ticket where cid='$_COOKIE[user]'";
        ...
        <div class="main">
                ...
                <div class="content-title"><?php if($display=='none'){?>No <?php }?>Tickets Booked<?php if($display=='inline'){?>:<?php }?></div>
                <div style="display:<?php echo $display;?>;" class="data">
                    ...
                    <tr>
                            ...
                            <td><a class="edit" href="ticketdownload.php?tno=<?php echo $row['tno'];?>">Download</a></td>
                        </tr>
