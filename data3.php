            ...
            <div class="main">
                <div class="content">
                    ...
                    <div class="datesection">
                        ...
                        ?>
                        <div class="selectdate" <?php if($date==$daterow['arr_date']){?>id="selected"<?php }else{?> onclick="window.location.href='data3.php?date=<?php echo $daterow['arr_date']; ?>'"<?php }?>>
                            <div class="date">
                                <?php 
                    ...
                    <form action="getdata.php" method="post">
                        ...
                        <div class="section">
                        <?php
                        $query="SELECT seatschedule.seatno,flight.to,flight.from,schedule.sid,schedule.dep_time,schedule.arr_time,flight.fid,seat.classid,afrom.city AS city1,ato.city AS city2,class.type,seat.aisle
                        from seat
                        ...
                        while($row=mysqli_fetch_array($direct)){
                            ...
                            $aisle=$row['aisle'];
                            if($aisle=="rw")
                                $aislename="Rightside Window";
                            else if($aisle=="rm")
                                $aislename="Rightside Middle";
                            else if($aisle=="lw")
                                $aislename="Leftside Window";
                            else
                                $aislename="Leftside Middle";
                            $value=$fid1.$sid1.$classid.$seatno.$cost2.substr($departtime,0,5).substr($arrtime,0,5)."dir";
                            
                            ?>
                        <label for="<?php echo $value;?>">
                            <div class="checkbox">
                                <input class="checkbtn" type="checkbox" name="sel[]" id="<?php echo $value;?>" value="<?php echo $value;?>">
                            </div>
                            <div class="inside">
                                <div class="seat">
                        ...
                        <?php if($flag){ ?>
                        <div><input id="btn" type="submit" value="Book"></div>
...
<div class="sidebar">
    ...
    <a class="logo-a" href="index.php"><p class="logo"></p></a>
    <ul >
