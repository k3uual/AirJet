...
<html>
    ...
    <div class="container">
        ...
        <div class="main">
                ...
                <div class="content-title">Flight Data:</div>
                <div class="data">
                    ...
                    <tr>
                            ...
                            <td><?php echo $row['no of seats'];?></td>
                            <td><?php echo $row['from'];?></td>
                            <td><?php echo $row['to'];?></td>
                            <td><?php echo $row['terminal'];?></td>
                            <td><a class="edit" href="update.php?file=flight&id=<?php echo $row['fid']; ?>&key=fid"><i class="fa fa-pencil fa-lg"></i></a></td>
                            <td><i onclick="window.location.href='remove.php?file=flight&id=<?php echo $row['fid']; ?>&key=fid'" class="fa remove fa-trash-o fa-lg"></i></td>
                        </tr>
