        ...
        <div class="main">
                ...
                <div class="data">
                    ...
                    <tr>
                            ...
                            <td><a class="edit" href="update.php?file=customers&id=<?php echo $row['cid']; ?>&key=cid"><i class="fa fa-pencil fa-lg"></i></a></td>
                            <td><i onclick="window.location.href='remove.php?file=customers&id=<?php echo $row['cid']; ?>&key=cid'" class="fa remove fa-trash-o fa-lg"></i></td>
                        </tr>
